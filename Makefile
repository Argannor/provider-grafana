...
IMAGES = provider-grafana
-include build/makelib/imagelight.mk

# ====================================================================================
# Setup XPKG

XPKG_REG_ORGS ?= xpkg.upbound.io/argannor-oss
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/argannor-oss
...
# NOTE(hasheddan): the build submodule currently overrides XDG_CACHE_HOME inF
...
# This target prepares repo for your provider by replacing all "grafana"
