...
The [provider-grafana](https://github.com/argannor/provider-grafana) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/argannor/provider-grafana/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/argannor/provider-grafana/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/argannor/provider-grafana/blob/main/hack/boilerplate.go.txt](https://github.com/argannor/provider-grafana/blob/main/hack/boilerplate.go.txt)
...
The [provider-grafana](https://github.com/argannor/provider-grafana)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/argannor/provider-grafana/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/argannor/provider-grafana/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue grafanas (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/argannor/provider-grafana/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Grafanas: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/argannor/provider-grafana/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
